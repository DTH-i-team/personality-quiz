...
quiz_data = {
    ...
    */
    ...
    "description": "Valentine's Day is a time to celebrate and spread love, and that includes loving yourself. Besides hanging out with friends, getting that extra cookie after dinner or not doing that one assignment you’ve been dreading, find a new way to show yourself the love and self-care you deserve.",
    ...
    */
    ...
    "results": [
	   ...
	   "source": "Giphy.com",
        ...
        /*  Result 3 */
        {
        "title": "Drink a glass of water first thing each morning!",
        "description": "Drink a full glass of water each morning before you do ANYTHING. Hydration is key to physical health and your emotional health tends to mirror your physical.",
        ...
        /*  Result 4 */
        {
        "title": "Put lotion on each night before bed",
        "description": "Rub your whole body down each night with some lotion after your evening shower. Lathering up with lotion at the end of the day is a great way to keep your skin glowing but also to remind yourself that your body is a wonderland.",
    ...
    */
    ...
    "questions": [
       ...
       {"question": "What are you most stressed about this week?",
         "answers": [
             {
                "text": "Internships",
                "result": 2
		     ...
		     {
                "text": "The Duke-UNC ticket lottery",
                "result": 1
             },
